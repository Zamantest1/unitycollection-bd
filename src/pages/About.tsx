      ...
      <div className="bg-background min-h-screen">
        ...
        <div className="bg-secondary py-12">
          <div className="container mx-auto px-4 text-center">
            ...
            <motion.p
              className="text-primary-foreground/80 mt-2 max-w-xl mx-auto"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
        ...
        <div className="container mx-auto px-4 py-12 space-y-16">
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {[
                { icon: Shirt, label: "Quality Fabric Selection" },
                { icon: Heart, label: "Elegant & Modest Designs" },
                { icon: Users, label: "Comfortable Fits" },
                { icon: Award, label: "Affordable Pricing" }
              ].map((item, index) => (
                <motion.div
                  key={item.label}
                  className="bg-card rounded-lg p-5 text-center shadow-sm hover:shadow-md transition-shadow"
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-3 max-w-2xl mx-auto">
              {[
                ...
                <motion.span
                  key={item}
                  className="bg-gold-soft text-foreground px-4 py-2 rounded-full text-sm font-medium"
