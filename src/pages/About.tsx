          ...
          duration: 0.6
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="space-y-4 text-muted leading-relaxed">
                <p> Unity Collection is a Bangladeshi traditional clothing brand focused on men's ethnic wear, especially Punjabi, designed for cultural, religious, and festive occasions such as Eid, Ramadan, weddings, and special family events. Unity Collection is a Bangladeshi traditional clothing brand focused on men's ethnic wear, especially Punjabi (Panjabi), designed for cultural, religious, and festive occasions such as Eid, Ramadan, weddings, and special family events.<strong className="text-foreground"> ()</strong> is a Bangladeshi traditional clothing brand focused on men's ethnic wear, especially <span className="text-gold font-medium">Punjabi (Panjabi)</span>, designed for cultural, religious, and festive occasions such as Eid, Ramadan, weddings, and special family events.
                </p>
                <p>
