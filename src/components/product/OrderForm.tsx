...
import { MessageCircle, Loader2, Tag, Check, X } from "lucide-react";
...
const WHATSAPP_NUMBER = "8801XXXXXXXXX"; // Will be updated with actual number
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 border-t border-border pt-6">
      ...
      <div className="space-y-2">
        ...
        {appliedCoupon ? (
          <div className="flex items-center gap-2 p-3 bg-gold-soft/50 rounded-md">
            <Check className="h-4 w-4 text-primary" />
            <span className="text-sm font-medium">{appliedCoupon.code}</span>
            <span className="text-sm text-muted">(-৳{appliedCoupon.discount})</span>
            <button
              type="button"
      ...
      {/* Order Summary */}
      <div className="bg-gold-soft/30 rounded-lg p-4 space-y-2">
